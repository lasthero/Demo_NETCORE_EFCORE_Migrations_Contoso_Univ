...
namespace ContosoUniversity_NETCORE_EFCORE.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id, byte[] rowVersion)
        {
            ...
            var departmentToUpdate = await _context.Departments.Include(d => d.Administrator).SingleOrDefaultAsync(m=>m.DepartmentID == id);
